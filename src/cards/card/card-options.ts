...
export const CardOptionsList: ICardOption[] = [
    ...
    },
    {
        ...
        description: `The card type. Must be "Equipment", "Hero", "Location", `
                   + `"Starter", "Super Power", "Villain", "Villain Nemesis", "Weakness", or "White Card". `
    ...
    },
    {
        name: "Variant",
        type: "text",
        description: `Select a variant type for the card. "Super Hero" or "Super-Villain" enables the black text box `
                   + `and Super-Hero/Villain subtype. "Impossible" uses the Imp template for Super-Villains. `
