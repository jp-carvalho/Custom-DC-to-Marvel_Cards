...
export class LiveEditorTab extends Tab {
    ...
    private updateVariantOptions(row: IRowData): void {
        ...
        if (type === "Hero" || type === "Herói") {
            desiredOptions = ["", "Super Hero", "Infinity War", "Crisis", "Speedster", "Symbiote", "Unity", "Transformed", "MC Transform", "Base transform", "Hero lvl 1", "Hero lvl 2", "Hero lvl 3", "Hero lvl 4", "Bribe 1", "Bribe 2", "Bribe 3", "Bribe 4", "Bribe 5"];
            ...
            desiredOptions = ["", "Transform", "Transform Base", "Symbiote", "Bribe 1", "Bribe 2", "Bribe 3", "Bribe 4", "Bribe 5", "Infinity Stone"];
