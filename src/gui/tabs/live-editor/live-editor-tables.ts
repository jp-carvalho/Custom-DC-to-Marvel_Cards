...
export const setsData = [
    ...
    { original: "Super Friends", en: "Super", pt: "Super", text: "#FFFFFF", bg: "#0074D9" },
];
...
export const cardsHeadings: IColumnData[] = [
    ...
    {
        name: "Type",
        allowedValues: ["Equipment", "Hero", "Location", "Starter", "Super Power", "Villain", "Villain Nemesis", "Weakness", "Hostage", "White Card"],
    },
    {
        name: "Text",
        longText: true,
    ...
    {
        name: "Variant",
        allowedValues: ["", "Super Hero", "Super-Villain", "Impossible", "Hero lvl 1", "Hero lvl 2", "Hero lvl 3", "Hero lvl 4", "Villain lvl 1", "Villain lvl 2", "Villain lvl 3", "Villain lvl 4", "Infinity War", "Crisis", "Speedster", "Symbiote", "Unity", "Transformed", "Transform", "Transform Base", "MC Transform", "Base transform", "Bribe 1", "Bribe 2", "Bribe 3", "Bribe 4", "Bribe 5", "Materialization", "Infinity Stone"],
    },
    {
        name: "Oversized",
        type: "boolean",
